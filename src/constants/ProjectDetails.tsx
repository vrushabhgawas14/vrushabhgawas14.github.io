...
export const Details = [
  ...
  },
  {
    ...
    name: "Athawda Bazaar",
    bio: "Its my college event where interested students are allowed to setup stall and sell their products. I developed a offical website for this event.",
  ...
  //   bio: "A modern travel agency project offering seamless and fast travel experiences.",
